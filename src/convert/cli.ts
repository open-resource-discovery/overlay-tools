...
function printHelp(): void {
	...
	process.stderr.write(`  ord-overlay convert enrichment.json\n`);
	process.stderr.write(
		`  ord-overlay convert enrichment.json --definition-type edmx\n`,
	);
	process.stderr.write(
		`  ord-overlay convert enrichment.json -o output.overlay.json\n`,
	);
}
