import type { OverlaySelector } from "../spec";
...
export function resolveSelector(
	...
	throw new OverlayMergeError(
		"Unsupported selector. Supported selectors: root, jsonPath, operation, entityType, complexType, enumType, propertyType, entitySet, namespace, parameter, returnType.",
	);
}
...
export function isOpenApiDefinitionType(
	definitionType: string | undefined,
): boolean {
	return (
...
export function isSpecificationId(definitionType: string): boolean {
