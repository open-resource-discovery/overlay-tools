...
import { convertODataV2EnrichmentToOrd } from "../../src/convert/convert-odata-v2";
import type { ODataV2Enrichment } from "../../src/convert/types";
...
test("descriptionAnnotations omits keys when value is empty string", () => {
	const enrichment: ODataV2Enrichment = {
		protocol: "odatav2",
		entityTypes: [
			{
				name: "Customer",
	...
	const { overlay } = convertODataV2EnrichmentToOrd(enrichment);
